...
export function PromoModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50" onClick={onClose}>
      <div
        className="relative max-w-sm w-full mx-4 rounded-2xl bg-white dark:bg-[#1e293b] p-8 shadow-2xl"
        onClick={(e) => e.stopPropagation()}
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
        >
          &times;
        </button>
        ...
        <div className="text-center">
          ...
          <div className="bg-gray-50 dark:bg-[#0f172a] rounded-xl p-4 mb-5">
            <p className="text-[11px] text-gray-400 dark:text-gray-500 uppercase tracking-wider font-semibold mb-2">Code promo</p>
