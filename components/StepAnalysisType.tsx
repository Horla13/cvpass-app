  ...
  return (
    <div className="max-w-[900px] mx-auto">
      ...
      <div className="flex items-center justify-center gap-3 mb-8">
        <div className="flex items-center gap-2 bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-full px-4 py-2 text-[14px]">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#16a34a" strokeWidth="2.5"><polyline points="20 6 9 17 4 12" /></svg>
          <span className="text-green-700 dark:text-green-400 font-medium">CV uploadé : {filename}</span>
        </div>
      </div>
      ...
      <p className="text-brand-gray dark:text-gray-400 text-center mb-4">
        Sélectionnez comment analyser et optimiser votre CV
      </p>

      {/* Crédits restants */}
      <div className="flex items-center justify-center gap-3 mb-8">
        <div className="flex items-center gap-2 bg-white dark:bg-[#1e293b] border border-gray-200 dark:border-gray-700 rounded-full px-4 py-2 text-[14px]">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <h3 className="font-display text-[20px] font-bold mb-2 dark:text-gray-100">Analyse ATS générale</h3>
          ...
          <div className="w-full bg-brand-black text-white rounded-xl py-3 text-center font-semibold text-[15px] group-hover:bg-gray-800 dark:bg-gray-200 dark:text-gray-900 dark:group-hover:bg-gray-300 transition-colors">
        ...
        <button
          onClick={() => onChoose("jd")}
          className="group text-left border border-gray-200 dark:border-gray-700 rounded-2xl p-8 hover:border-brand-green/50 hover:shadow-md transition-all relative dark:bg-[#1e293b]"
        >
          ...
          <h3 className="font-display text-[20px] font-bold mb-2 dark:text-gray-100">Match offre d&apos;emploi</h3>
          <p className="text-brand-gray dark:text-gray-400 text-[14px] leading-relaxed mb-6">
