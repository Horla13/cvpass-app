          ...
          <div className="border-2 border-green-200 rounded-xl p-6 relative">
            ...
            <div className="flex items-start justify-between mb-1">
              <div>
                ...
                <p className="text-gray-500 text-[13px]">Idéal pour postuler à cette offre rêvée</p>
              </div>
          ...
          <div className="border-2 border-blue-200 rounded-xl p-6 bg-blue-50/30 relative">
            ...
            <div className="flex items-start justify-between mb-1">
              <div>
                ...
                <p className="text-gray-500 text-[13px]">Scans illimités pendant {selectedMonths * 30} jours</p>
              </div>
              <div className="text-right">
                {monthData.discount > 0 && (
                  <>
                    <div className="text-[13px] text-gray-400 line-through">{formatPrice(fullPrice)}&euro;</div>
                    <div className="text-[24px] font-extrabold text-gray-900">{formatPrice(monthData.price)}&euro;</div>
                ...
                <div className="text-[12px] text-gray-400">pour {selectedMonths} mois</div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-4 my-5">
              <button
                ...
                className="w-8 h-8 rounded-full border-2 border-gray-300 flex items-center justify-center text-gray-500 hover:border-blue-400 hover:text-blue-500 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
              >
            ...
            <ul className="space-y-2.5 mb-5 text-[13.5px] text-gray-600">
