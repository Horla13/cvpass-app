          ...
          <div className="border-2 border-green-200 dark:border-green-700 rounded-xl p-6 relative dark:bg-[#1e293b]">
            ...
            <div className="flex items-start justify-between mb-1">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-[13px]">+4 crédits immédiatement</p>
              </div>
          ...
          <div className="border-2 border-blue-200 dark:border-blue-700 rounded-xl p-6 bg-blue-50/30 dark:bg-blue-900/20 relative">
            ...
            <div className="flex items-start justify-between mb-1">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-[13px]">Analyses illimitées pendant 30 jours</p>
              </div>
              <div className="text-right">
                <div className="text-[24px] font-extrabold text-gray-900 dark:text-gray-100">8,90&euro;</div>
                <div className="text-[12px] text-gray-400 dark:text-gray-500">par mois</div>
              </div>
            </div>
