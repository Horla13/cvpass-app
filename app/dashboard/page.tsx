...
type Step = "select" | "type" | "jd" | "analyzing";
...
export default function DashboardPage() {
  ...
  const handleSelectResume = useCallback((id: string) => {
    ...
    if (analysis) {
      ...
      // For re-analysis, user needs to upload the CV file again
      // Navigate to type selection — they can upload from there
      setStep("type");
    }
  }, [analyses]);
  ...
  const handleChooseType = (type: "ats" | "jd") => {
    ...
    if (type === "jd") {
      ...
      // ATS analysis — go straight to analyzing
      runAnalysis("", type);
    }
  };
